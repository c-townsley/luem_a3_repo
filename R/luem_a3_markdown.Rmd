...
ggplot() +
  ...
  labs(title="Flood Inundation in Calgary",
       subtitle="Based on observed flooding in Calgary in XX, 20XX",
...
Mapping the features for our comparison city, Denver, we see...
